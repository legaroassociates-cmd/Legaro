...
// ../.wrangler/tmp/bundle-rizaLg/checked-fetch.js
  ...
  try {
    ...
    <body>
      <div class="container">
        ...
        <div class="footer">
          <p>&copy; ${(/* @__PURE__ */ new Date()).getFullYear()} Legaro Associates. All rights reserved.</p>
    ...
    const resendResponse = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        // Change to verified domain in prod
        to: [email],
...
// ../.wrangler/tmp/pages-LXqeve/functionsRoutes-0.027363707152507688.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-rizaLg/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-rizaLg/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8159734939146492.mjs.map
